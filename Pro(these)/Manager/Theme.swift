...
enum Theme: String, CaseIterable {    
    ...
    var primary: Color { // gesättigt
        switch self {
            ...
            case .pink: return Color(red: 52/255, green: 52/255, blue: 52/255)
        }
    }
    ...
    var secondary: Color { // light
        switch self {
            ...
            case .pink: return Color(red: 255/255, green: 130/255, blue: 80/255)
        }
    }
    ...
    var hightlightColor: Color { // GESÄTTIGTE FARBE
        switch self {
            ...
            case .pink: return Color(red: 156/255, green: 34/255, blue: 93/255) // 219 48 130
        }
    }
    ...
    var accentColor: Color { // UNGESÄTTIGE FARBE
        switch self {
            ...
            case .pink: return Color(red: 219/255, green: 48/255, blue: 130/255)
        }
    }
